        ...
        <div style="max-width:600px; margin:0 auto; padding:40px 20px;">
          ...
          <div style="background:#18181b; border:1px solid #27272a; border-radius:12px; padding:32px;">
            ...
            <p style="margin:0; font-size:12px; color:#52525b; line-height:1.6;">
              Este link é válido por <strong style="color:#71717a;">1 hora</strong>.
              Se você não solicitou a recuperação de senha, ignore este email — sua conta continua segura.
            </p>
          </div>
