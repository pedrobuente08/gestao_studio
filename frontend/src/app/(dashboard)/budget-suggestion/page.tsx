...
import { Lightbulb, TrendingUp, Database, Search, AlertCircle } from 'lucide-react';
            ...
            {hasEnoughData ? (
              <>
                <p className="text-xs text-zinc-500">
                  Baseado em <span className="text-zinc-300 font-medium">{result.count} procedimento{result.count !== 1 ? 's' : ''}</span> similares registrados
                </p>
                ...
                {result.sessions.length > 0 && (
                  <div className="space-y-2 pt-2 border-t border-zinc-800">
                    <span className="text-[10px] text-zinc-500 uppercase font-bold">Procedimentos usados como referência</span>
              ...
              <div className="flex flex-col items-center justify-center py-8 text-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-500 text-sm mt-1">
                    ...
                    {' '}Registre mais procedimentos para obter sugestões precisas.
                  </p>
                </div>
              </div>
            )}
